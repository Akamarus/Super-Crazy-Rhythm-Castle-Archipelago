...
Write-Host "Building RhythmCastleAP v0.69.0 against:" $GameDir
...
Write-Host "2. Confirm BepInEx\LogOutput.log says: [SCRC-AP] v0.69.0 loading."
Write-Host "3. Set DirectStartAtPhoneHub=true, EnableAreaAccessPrototype=true, and PrototypeStartingArea=AP."
Write-Host "4. Use a fresh compatible APWorld v0.23 seed and fresh save; Music Lab Points manual acceptance is pending."
