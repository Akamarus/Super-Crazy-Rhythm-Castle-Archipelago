...
This is an unofficial, experimental development build rather than a release. The tables below distinguish the current v0.67.65 client / v0.19 APWorld focused repair candidate from the approved future randomizer design. Testers should use matching source builds and a fresh v0.19 seed/save.
...
| Work | Status | Current v0.67.65 / v0.19 boundary |
| --- | --- | --- |
