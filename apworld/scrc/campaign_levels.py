...
CAMPAIGN_LEVELS: tuple[CampaignLevel, ...] = (
    _level(1, "Light Humor", "Level_05", "Roots"),
    _level(2, "Pop Party", "Level_06", "Roots"),
    _level(3, "The Megafying Ritual", "Level_07", "Roots"),
    _level(4, "DJ Eggplant", "Level_08", "Roots"),
    ...
    _level(12, "Act 2: Sauce and Spice", "Level_15", "Meat Dimension"),
    _level(13, "Act 3: Montage", "Level_22", "Meat Dimension"),
    _level(14, "Act 4: Habanero", "Level_23", "Meat Dimension"),
    _level(15, "Central Mainframe", "Level_16", "Cell Tower"),
    _level(16, "The Thief Prince", "Level_24", "Cell Tower"),
    _level(17, "Cold Storage", "Level_21", "Lobby"),
    _level(18, "The Darkness", "Level_03", "Tower of Fear"),
